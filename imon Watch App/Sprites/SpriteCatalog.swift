...
extension SpriteCatalog {
    ...
    private static func dotkinFrames(
...
extension SpriteCatalog {
    ...
    private static func hopkinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0000, //  ................
...
extension SpriteCatalog {
    ...
    private static func emberkinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0000, //  ................
...
extension SpriteCatalog {
    ...
    private static func marshkinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0000, //  ................
...
extension SpriteCatalog {
    ...
    private static func rexkinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0100, //  .......#........  horn
...
extension SpriteCatalog {
    ...
    private static func blazekinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0000, //  ................
...
extension SpriteCatalog {
    ...
    private static func dreadkinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0380, //  ......###.......  horns
...
extension SpriteCatalog {
    ...
    private static func pyrekinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0100, //  .......#........  flame tip
...
extension SpriteCatalog {
    ...
    private static func galekinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0000, //  ................
...
extension SpriteCatalog {
    ...
    private static func tidekinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0000, //  ................
...
extension SpriteCatalog {
    ...
    private static func sludgekinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0000, //  ................
...
extension SpriteCatalog {
    ...
    private static func steelkinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0180, //  .......##.......  horn
...
extension SpriteCatalog {
    ...
    private static func orbkinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0000, //  ................
...
extension SpriteCatalog {
    ...
    private static func plushkinFrames(
        _ kind: AnimationKind
    ) -> [SpriteFrame] {
        let idle1 = SpriteFrame(rows: [
            0x0000, //  ................
